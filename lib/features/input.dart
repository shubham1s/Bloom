...
// utils
import 'package:BLOOM_BETA/example/lib/utils/time.dart';

// widgets
import 'package:BLOOM_BETA/example/lib/presentation/widgets/custom_form_fields.dart';
import 'package:BLOOM_BETA/example/lib/presentation/widgets/custom_progress_indicator.dart';
            ...
            children: [
              Expanded(
                  ...
                  child: CustomFormField(
                    label: 'Water',
                    child: TextFormField(
                      controller: TextEditingController(text: '$water'),
                      decoration: InputDecoration(
                        border: InputBorder.none,
                        hintText: '3200 mL',
                        suffixText: 'mL',
